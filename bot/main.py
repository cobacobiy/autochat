...
from bot.config import POLL_INTERVAL_SECONDS, MAX_CACHE_SIZE
from bot.utils import do_human_delay


from playwright.async_api import async_playwright

from bot.config import LOG_DIR, LOG_FORMAT, PROFILE_DIR, SHOPEE_CHAT_URL, UNANSWERED_PATH, KNOWLEDGE_PATH
...
async def run_bot():
    ...
    bot_state.replied_cache = bot_state.replied_cache
